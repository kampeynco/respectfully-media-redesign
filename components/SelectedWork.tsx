    ...
    <section id="work" className="py-24 bg-secondary relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          ...
          <a href="https://vimeo.com/showcase/11225310?fl=so&fe=fs" target="_blank" rel="noopener noreferrer" className="hidden md:inline-flex items-center text-primary font-semibold hover:underline mt-4 md:mt-0">
        ...
        <div className="mt-12 text-center md:hidden">
          <a href="https://vimeo.com/showcase/11225310?fl=so&fe=fs" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-primary font-semibold hover:underline">
            View Full Portfolio <span className="material-symbols-outlined ml-1 text-sm">arrow_forward</span>
          </a>
        </div>
      </div>
